...
|
*/
$config['base_url'] = 'http://localhost/CI3_E-Commerce_Store/';
...
$config['csrf_exclude_uris'] = ['home/payment_success'];
...
$config['razorpay_key_id'] = 'rzp_test_S9zWf53uWLQtag';
$config['razorpay_key_secret'] = 'w0UYTCyWpU8LRNp4r4wHQxhd';